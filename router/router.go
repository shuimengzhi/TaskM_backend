...
func NewRouter() *gin.Engine {
	...
	taskTag := r.Group("/task_tag")
	{
		taskTag.Use(middleware.AuthRequired())

		taskTag.POST("/create", task_controller.TaskTagCreate)
		taskTag.POST("/update", project_controller.ProjectUpdate)
	}
	return r
}
